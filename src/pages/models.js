...
export default function Models() {
  let arreglo = [
    ...
    { Code: 2, Name: "/models/model/bmw.glb", Poster:'/models/poster/avatarTest.JPG'},
    { Code: 3, Name: "/models/model/bmw.glb", Poster:'/models/poster/avatarTest.JPG'},
    { Code: 4, Name: "/models/model/bmw.glb", Poster:'/models/poster/avatarTest.JPG'},
    ...
    { Code: 10, Name: "/models/model/bmw.glb", Poster:'/models/poster/avatarTest.JPG'},
    ...
    { Code: 13, Name: "/models/model/bmw.glb", Poster:'/models/poster/avatarTest.JPG'},
